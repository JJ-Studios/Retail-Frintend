...
export { numNoShipItems };

let numNoShipItems = 0;

function NoShippingAd() {
  let categories;
  ...
  numNoShipItems = adList.length;

  const getAds = () => {
    Axios.get("https://bathhut-api.herokuapp.com/GetNoShipAds").then(
      (response) => {
